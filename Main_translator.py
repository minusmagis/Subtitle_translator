                ...
                if index_1 == 0:
                    ...
                    for i in range(40):
                        if translated_sentence_full_temporal[min(max(0,white_space_to_cut - 20 +i),len(translated_sentence_full)-1)] == ',':
                            translated_sentence_full_temporal[min(max(0,white_space_to_cut - 20 +i),len(translated_sentence_full)-1)] = ',ß'
                            commafound = True
                            break
                    if not commafound:
                ...
                if index_1 == 0:
                    ...
                    for i in range(40):
                        if translated_sentence_full_temporal[min(max(0,place_to_cut - 20 +i),len(translated_sentence_full_temporal)-1)] == ',':
                            translated_sentence_full_temporal[min(max(0,place_to_cut - 20 +i),len(translated_sentence_full_temporal)-1)] = ',ß'
                            commafound = True
                            break
                    if not commafound:
                        translated_sentence_full_temporal[place_to_cut] = 'ß'
